...
def create_routes(server):
    ...
    """
    @api {get} /git/lines_commited/:facade_repo_url Lines Changed by Author
    @apiName commits-changed-by-author
    @apiGroup Experimental
    @apiDescription This is an Augur-specific metric. We are currently working to define these more formally. Source: Git Repository
    ...
    """
    server.addGitMetric(facade.commits_changed_by_author, 'commits_by_author')
